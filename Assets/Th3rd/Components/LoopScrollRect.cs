...
namespace UnityEngine.UI
{
    ...
    public abstract class LoopScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        ...
        protected Action<GameObject, int> onCreateCallBack = null;
        ...
        public void RefillCells(int offset = 0, bool fillViewRect = false, Action<GameObject, int> onCreateCallBack = null)
        {
            if (!Application.isPlaying || prefabSource == null)
                return;
            ...
            if (fillViewRect && itemSize > 0 && sizeFilled < sizeToFill)
            {
                ...
                if (newOffset != offset) RefillCells(newOffset, fillViewRect, onCreateCallBack);                 //refill again, with the new offset value, and now with fillViewRect disabled.
            }
        ...
        {            
            ...
            onCreateCallBack?.Invoke(nextItem.gameObject, itemIdx);
            return nextItem;
        }
        //==========LoopScrollRect==========
