...
namespace XLua.CSObjectWrap
{
    ...
    public class B2FrameworkSceneAssetAsyncRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(B2Framework.SceneAssetAsyncRequest);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3))
				{
					...
					B2Framework.SceneAssetAsyncRequest gen_ret = new B2Framework.SceneAssetAsyncRequest(_path, _additive);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to B2Framework.SceneAssetAsyncRequest constructor!");
        ...
        static int _g_get_progress(RealStatePtr L)
        {
		    try {
                ...
                B2Framework.SceneAssetAsyncRequest gen_to_be_invoked = (B2Framework.SceneAssetAsyncRequest)translator.FastGetCSObj(L, 1);
