...
namespace XLua.CSObjectWrap
{
    ...
    public class B2FrameworkReferenceWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(B2Framework.Reference);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new B2Framework.Reference();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to B2Framework.Reference constructor!");
        ...
        static int _m_IsUnused(RealStatePtr L)
        {
		    try {
                ...
                B2Framework.Reference gen_to_be_invoked = (B2Framework.Reference)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    
                        var gen_ret = gen_to_be_invoked.IsUnused(  );
