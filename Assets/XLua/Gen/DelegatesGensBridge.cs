...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp7(XLua.LuaTable p0, float p1, float p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp8(XLua.LuaTable p0, float p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp9(XLua.LuaTable p0, string p1, string p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp10(UnityEngine.SceneManagement.Scene p0, UnityEngine.SceneManagement.LoadSceneMode p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp11(UnityEngine.SceneManagement.Scene p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Action<XLua.LuaTable, float, float>))
			{
			    return new System.Action<XLua.LuaTable, float, float>(__Gen_Delegate_Imp7);
			}
		
		    if (type == typeof(System.Action<XLua.LuaTable, float>))
			{
			    return new System.Action<XLua.LuaTable, float>(__Gen_Delegate_Imp8);
			}
		
		    if (type == typeof(System.Action<XLua.LuaTable, string, string>))
			{
			    return new System.Action<XLua.LuaTable, string, string>(__Gen_Delegate_Imp9);
			}
			...
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene, UnityEngine.SceneManagement.LoadSceneMode>(__Gen_Delegate_Imp10);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene>))
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.SceneManagement.Scene>(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(System.Action<UnityEngine.GameObject, int>))
			{
			    return new System.Action<UnityEngine.GameObject, int>(__Gen_Delegate_Imp12);
			}
