...
namespace XLua.CSObjectWrap
{
    ...
    public class B2FrameworkWebAssetRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(B2Framework.WebAssetRequest);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					B2Framework.WebAssetRequest gen_ret = new B2Framework.WebAssetRequest();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to B2Framework.WebAssetRequest constructor!");
        ...
        static int _g_get_isDone(RealStatePtr L)
        {
		    try {
                ...
                B2Framework.WebAssetRequest gen_to_be_invoked = (B2Framework.WebAssetRequest)translator.FastGetCSObj(L, 1);
