        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new B2Framework.Assets();
		    ...
		    try {
                ...
                
                {
                    ...
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        var gen_ret = B2Framework.Assets.LoadAsset( _path, _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        var gen_ret = B2Framework.Assets.LoadAssetAsync( _path, _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _additive = LuaAPI.lua_toboolean(L, 2);
                        ...
                        var gen_ret = B2Framework.Assets.LoadSceneAsync( _path, _additive );
                        translator.Push(L, gen_ret);
