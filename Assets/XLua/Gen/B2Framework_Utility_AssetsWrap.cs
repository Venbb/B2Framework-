        ...
        static int _m_CreatePersistentDataDir_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = B2Framework.Utility.Assets.CreatePersistentDataDir(  );
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = B2Framework.Utility.Assets.GetPersistentDataPath( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = B2Framework.Utility.Assets.GetStreamingAssetsDataPath( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = B2Framework.Utility.Assets.GetPersistentDataRemotePath( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = B2Framework.Utility.Assets.GetStreamingAssetsRemotePath( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = B2Framework.Utility.Assets.GetDownloadURL( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = B2Framework.Utility.Assets.GetDataPath( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = B2Framework.Utility.Assets.GetAssetPath( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<B2Framework.AssetBundles>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = B2Framework.Utility.Assets.GetAssetPath( _bundle, _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = B2Framework.Utility.Assets.IsRemote( _path );
