        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					B2Framework.PreloadManager gen_ret = new B2Framework.PreloadManager();
		    ...
		    try {
                ...
                
                {
                    ...
                    System.Type _type = (System.Type)translator.GetObject(L, 3, typeof(System.Type));
                        ...
                        B2Framework.AssetLoader gen_ret = gen_to_be_invoked.AddAsset( _path, _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _additive = LuaAPI.lua_toboolean(L, 3);
                        ...
                        B2Framework.SceneLoader gen_ret = gen_to_be_invoked.AddScene( _path, _additive );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        B2Framework.GameObjectLoader gen_ret = gen_to_be_invoked.AddGameObject( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.GameObject gen_ret = gen_to_be_invoked.GetGameObject( _path );
                        translator.Push(L, gen_ret);
