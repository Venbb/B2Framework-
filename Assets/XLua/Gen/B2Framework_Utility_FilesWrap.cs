		    ...
		    try {
                ...
                
                {
                    ...
                    string[] _extents = translator.GetParams<string>(L, 2);
                        ...
                        string[] gen_ret = B2Framework.Utility.Files.GetFiles( _path, _extents );
		    ...
		    try {
                ...
                
                {
                    ...
                    string[] _extents = translator.GetParams<string>(L, 2);
                        ...
                        string[] gen_ret = B2Framework.Utility.Files.GetFilesExcept( _path, _extents );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = B2Framework.Utility.Files.DeleteDir( _path );
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = B2Framework.Utility.Files.DeleteFile( _path );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    string _destFileName = LuaAPI.lua_tostring(L, 2);
                        ...
                        bool gen_ret = B2Framework.Utility.Files.RenameFile( _sourceFileName, _destFileName );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        byte[] gen_ret = B2Framework.Utility.Files.ReadAllBytes( _path );
		    ...
		    try {
                ...
                
                {
                    ...
                    byte[] _bytes = LuaAPI.lua_tobytes(L, 2);
                        ...
                        bool gen_ret = B2Framework.Utility.Files.WriteAllBytes( _path, _bytes );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = B2Framework.Utility.Files.GetMD5( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
