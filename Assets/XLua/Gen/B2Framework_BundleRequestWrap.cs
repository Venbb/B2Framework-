...
namespace XLua.CSObjectWrap
{
    ...
    public class B2FrameworkBundleRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(B2Framework.BundleRequest);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					B2Framework.BundleRequest gen_ret = new B2Framework.BundleRequest();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to B2Framework.BundleRequest constructor!");
        ...
        static int _g_get_assetBundle(RealStatePtr L)
        {
		    try {
                ...
                B2Framework.BundleRequest gen_to_be_invoked = (B2Framework.BundleRequest)translator.FastGetCSObj(L, 1);
