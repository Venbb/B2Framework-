...
namespace XLua.CSObjectWrap
{
    ...
    public class B2FrameworkDebugWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(B2Framework.Debug);
        ...
        {
            return LuaAPI.luaL_error(L, "B2Framework.Debug does not have a constructor!");
        }
        ...
        static int _m_Log_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    B2Framework.Debug.Log( _message );
        ...
        static int _m_LogFormat_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    B2Framework.Debug.LogFormat( _format, _args );
        ...
        static int _m_LogWarning_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    B2Framework.Debug.LogWarning( _message );
        ...
        static int _m_LogWarningFormat_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    B2Framework.Debug.LogWarningFormat( _format, _args );
        ...
        static int _m_LogError_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    B2Framework.Debug.LogError( _message );
        ...
        static int _m_LogErrorFormat_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    object _format = translator.GetObject(L, 1, typeof(object));
                    object[] _args = translator.GetParams<object>(L, 2);
                    
                    B2Framework.Debug.LogErrorFormat( _format, _args );
        ...
        static int _m_LogException_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    B2Framework.Debug.LogException( _exception );
