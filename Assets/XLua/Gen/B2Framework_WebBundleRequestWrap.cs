...
namespace XLua.CSObjectWrap
{
    ...
    public class B2FrameworkWebBundleRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(B2Framework.WebBundleRequest);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					B2Framework.WebBundleRequest gen_ret = new B2Framework.WebBundleRequest();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to B2Framework.WebBundleRequest constructor!");
        ...
        static int _g_get_error(RealStatePtr L)
        {
		    try {
                ...
                B2Framework.WebBundleRequest gen_to_be_invoked = (B2Framework.WebBundleRequest)translator.FastGetCSObj(L, 1);
