...
namespace XLua.CSObjectWrap
{
    ...
    public class B2FrameworkSceneAssetRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(B2Framework.SceneAssetRequest);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3))
				{
					...
					B2Framework.SceneAssetRequest gen_ret = new B2Framework.SceneAssetRequest(_path, _additive);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to B2Framework.SceneAssetRequest constructor!");
        ...
        static int _g_get_progress(RealStatePtr L)
        {
		    try {
                ...
                B2Framework.SceneAssetRequest gen_to_be_invoked = (B2Framework.SceneAssetRequest)translator.FastGetCSObj(L, 1);
