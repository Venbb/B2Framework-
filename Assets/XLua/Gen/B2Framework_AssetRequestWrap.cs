...
namespace XLua.CSObjectWrap
{
    ...
    public class B2FrameworkAssetRequestWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(B2Framework.AssetRequest);
			Utils.BeginObjectRegister(type, L, translator, 0, 2, 11, 3);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					B2Framework.AssetRequest gen_ret = new B2Framework.AssetRequest();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to B2Framework.AssetRequest constructor!");
        ...
        static int _m_MoveNext(RealStatePtr L)
        {
		    try {
                ...
                B2Framework.AssetRequest gen_to_be_invoked = (B2Framework.AssetRequest)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_loadState(RealStatePtr L)
        {
		    try {
                ...
                B2Framework.AssetRequest gen_to_be_invoked = (B2Framework.AssetRequest)translator.FastGetCSObj(L, 1);
                translator.PushB2FrameworkLoadState(L, gen_to_be_invoked.loadState);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_completed(RealStatePtr L)
        {
		    try {
                ...
                B2Framework.AssetRequest gen_to_be_invoked = (B2Framework.AssetRequest)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.completed = translator.GetDelegate<System.Action<B2Framework.AssetRequest>>(L, 2);
