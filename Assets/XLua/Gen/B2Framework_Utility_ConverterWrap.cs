		    ...
		    try {
                ...
                if(gen_param_count == 1&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 1)) 
                {
                    bool _value = LuaAPI.lua_toboolean(L, 1);
                        ...
                        string gen_ret = B2Framework.Utility.Converter.GetString( _value );
		    ...
		    try {
                ...
                
                {
                    string _value = LuaAPI.lua_tostring(L, 1);
                        ...
                        bool gen_ret = B2Framework.Utility.Converter.ToBoolean( _value );
		    ...
		    try {
                ...
                
                {
                    string _value = LuaAPI.lua_tostring(L, 1);
                        ...
                        float gen_ret = B2Framework.Utility.Converter.ToSingle( _value );
		    ...
		    try {
                ...
                
                {
                    string _value = LuaAPI.lua_tostring(L, 1);
                        ...
                        int gen_ret = B2Framework.Utility.Converter.ToInt32( _value );
		    ...
		    try {
                ...
                
                {
                    string _value = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = B2Framework.Utility.Converter.ToString( _value );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _value = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.Color gen_ret = B2Framework.Utility.Converter.ToColor( _value );
		    ...
		    try {
                ...
                
                {
                    string _value = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.Vector2 gen_ret = B2Framework.Utility.Converter.ToVector2( _value );
		    ...
		    try {
                ...
                
                {
                    string _value = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.Vector3 gen_ret = B2Framework.Utility.Converter.ToVector3( _value );
		    ...
		    try {
                ...
                
                {
                    string _value = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.Vector4 gen_ret = B2Framework.Utility.Converter.ToVector4( _value );
		    ...
		    try {
                ...
                
                {
                    string _value = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.Rect gen_ret = B2Framework.Utility.Converter.ToRect( _value );
