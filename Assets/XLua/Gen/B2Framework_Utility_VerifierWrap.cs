		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _str = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = B2Framework.Utility.Verifier.GetMD5( _str );
                ...
                if(gen_param_count == 1&& translator.Assignable<System.IO.Stream>(L, 1)) 
                {
                    System.IO.Stream _input = (System.IO.Stream)translator.GetObject(L, 1, typeof(System.IO.Stream));
                        ...
                        string gen_ret = B2Framework.Utility.Verifier.GetMD5( _input );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    byte[] _buffer = LuaAPI.lua_tobytes(L, 1);
                        ...
                        string gen_ret = B2Framework.Utility.Verifier.GetMD5( _buffer );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _str = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = B2Framework.Utility.Verifier.GetCRC32( _str );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 1&& translator.Assignable<System.IO.Stream>(L, 1)) 
                {
                    System.IO.Stream _input = (System.IO.Stream)translator.GetObject(L, 1, typeof(System.IO.Stream));
                        ...
                        string gen_ret = B2Framework.Utility.Verifier.GetCRC32( _input );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    byte[] _buffer = LuaAPI.lua_tobytes(L, 1);
                        ...
                        string gen_ret = B2Framework.Utility.Verifier.GetCRC32( _buffer );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    byte[] _data = LuaAPI.lua_tobytes(L, 1);
                        ...
                        string gen_ret = B2Framework.Utility.Verifier.ToHash( _data );
                        LuaAPI.lua_pushstring(L, gen_ret);
