        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					B2Framework.ScenesManager gen_ret = new B2Framework.ScenesManager();
		    ...
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _additive = LuaAPI.lua_toboolean(L, 3);
                        ...
                        B2Framework.ScenesManager gen_ret = gen_to_be_invoked.LoadSceneAsync( _sceneName, _additive );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _sceneName = LuaAPI.lua_tostring(L, 2);
                        ...
                        B2Framework.ScenesManager gen_ret = gen_to_be_invoked.LoadSceneAsync( _sceneName );
                        translator.Push(L, gen_ret);
