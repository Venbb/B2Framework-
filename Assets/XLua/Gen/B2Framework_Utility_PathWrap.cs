		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    bool _forward = LuaAPI.lua_toboolean(L, 2);
                        ...
                        string gen_ret = B2Framework.Utility.Path.GetRegularPath( _path, _forward );
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = B2Framework.Utility.Path.GetRegularPath( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    string[] _extents = translator.GetParams<string>(L, 2);
                        ...
                        bool gen_ret = B2Framework.Utility.Path.IsExtension( _path, _extents );
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = B2Framework.Utility.Path.GetFullPath( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    string _path2 = LuaAPI.lua_tostring(L, 2);
                        ...
                        string gen_ret = B2Framework.Utility.Path.Combine( _path1, _path2 );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = B2Framework.Utility.Path.GetExtension( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = B2Framework.Utility.Path.GetDirectoryName( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        string gen_ret = B2Framework.Utility.Path.GetFilePathWithoutExtension( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
