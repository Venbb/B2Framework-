...
namespace XLua.CSObjectWrap
{
    ...
    public class B2FrameworkAssetLoaderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(B2Framework.AssetLoader);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING) && translator.Assignable<System.Type>(L, 3))
				{
					...
					B2Framework.AssetLoader gen_ret = new B2Framework.AssetLoader(_assetPath, _assetType);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to B2Framework.AssetLoader constructor!");
        ...
        static int _m_IsDone(RealStatePtr L)
        {
		    try {
                ...
                B2Framework.AssetLoader gen_to_be_invoked = (B2Framework.AssetLoader)translator.FastGetCSObj(L, 1);
        ...
        static int _m_GetAsset(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        UnityEngine.Object gen_ret = gen_to_be_invoked.GetAsset(  );
                        translator.Push(L, gen_ret);
