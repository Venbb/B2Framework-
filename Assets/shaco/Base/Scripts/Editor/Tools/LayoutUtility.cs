...
public static class LayoutUtility
{
    ...
    static void Init()
    {
        Type tyWindowLayout = shaco.Base.Utility.Assembly.GetTypeWithinLoadedAssemblies("UnityEditor.WindowLayout,UnityEditor");
        Type tyEditorUtility = shaco.Base.Utility.Assembly.GetTypeWithinLoadedAssemblies("UnityEditor.EditorUtility,UnityEditor");
        Type tyInternalEditorUtility = shaco.Base.Utility.Assembly.GetTypeWithinLoadedAssemblies("UnityEditorInternal.InternalEditorUtility,UnityEditor");
    ...
    // Load current window layout to file.
