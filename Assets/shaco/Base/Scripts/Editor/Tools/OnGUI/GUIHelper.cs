...
namespace shacoEditor
{
    public partial class GUIHelper
    {
        ...
        /// <return>当前对象</return>
        /// </summary>
        static public T ObjectPicker<T>(string prefix, T pickObject, bool allowSceneObjects = true) where T : UnityEngine.Object
        {
            if (GUILayout.Button(prefix))
            {
                ...
                typeof(EditorGUIUtility)
                        ...
                        .Invoke(null, new object[] { null, allowSceneObjects, string.Empty, controlId });
