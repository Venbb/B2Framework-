...
namespace shacoEditor
{
    ...
    {
        [MenuItem("shaco/Other/UnityInternalSytleAndIconPreview", false, (int)ToolsGlobalDefine.MenuPriority.Other.INTERNAL_ICON_PREVIEW)]
        public static void ShowWindow()
        {
            BuiltInResourcesWindow w = (BuiltInResourcesWindow)EditorWindow.GetWindow<BuiltInResourcesWindow>(true);
            w.Show();
        }
