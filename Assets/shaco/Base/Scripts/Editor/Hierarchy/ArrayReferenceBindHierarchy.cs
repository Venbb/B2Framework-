...
namespace shacoEditor
{
    ...
    {
        private ArrayReferenceBindHierarchy _currentWindow = null;
        ...
        [MenuItem("GameObject/shaco/ReferenceBind", false, (int)ToolsGlobalDefine.HierachyMenuPriority.REFERENCE_BIND)]
        static public void OpenWindow()
        {
            if (Selection.activeGameObject != null)
            {
                EditorHelper.GetWindow<ArrayReferenceBindHierarchy>(null, true, "ArrayReferenceBind");
            }
        }
        ...
        void OnEnable()
        {
            if (Selection.activeGameObject != null)
            {
                _currentWindow = EditorHelper.GetWindow<ArrayReferenceBindHierarchy>(this, true, "ArrayReferenceBind");
                _currentWindow.Init();
            }
        }
