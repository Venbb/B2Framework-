...
{
    public class HotUpdatePathIntputWindow : EditorWindow
    {
        ...
        private HotUpdatePathIntputWindow _currentWindow = null;

        public static void OpenHotUpdatePathInputWindow(ON_SET_PATH_CALLBACK callback, Rect position)
        {
            var retValue = EditorWindow.GetWindow(typeof(HotUpdatePathIntputWindow), true, "HotUpdatePathIntputWindow") as HotUpdatePathIntputWindow;
