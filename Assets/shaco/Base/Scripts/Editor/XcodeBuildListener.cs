...
namespace shaco.iOS.Xcode
{
    public static class XcodeBuildListener
    {
        ...
        static private shacoEditor.BuildHelperWindow.IOSCodeIndentity IOS_CODE_INDENTITY;
        ...
        public static void OnPostProcessBuild(UnityEditor.BuildTarget target, string projectRootPath)
        {
            ...
            {
                DEVELOPMENT_TEAM = shacoEditor.BuildHelperWindow.GetIOSDevelepmentTeam();
                PROVISIONING_PROFILE_SPECIFIER = shacoEditor.BuildHelperWindow.GetIOSProvisioningProfileSpecifier();
                IOS_CODE_INDENTITY = shacoEditor.BuildHelperWindow.GetIOSCodeIndentity();
            }
        ...
        [shacoEditor.PostProcessBuilded]
        public static void OnPostProcessBuilded(UnityEditor.BuildTarget target, string projectRootPath)
        {
            Debug.Log("XcodeBuildListener OnPostProcessBuilded: target=" + target + " projectRootPath=" + projectRootPath);
        }

        public static bool InitEnviromentCommandValues()
        {
            DEVELOPMENT_TEAM = shaco.Base.Utility.GetEnviromentCommandValue("DEVELOPMENT_TEAM");
            PROVISIONING_PROFILE_SPECIFIER = shaco.Base.Utility.GetEnviromentCommandValue("PROVISIONING_PROFILE_SPECIFIER");
        ...
        private static void ModifyProject(PBXProject project, string projectRootPath, string targetGUIID)
        {
            ...
            {
                case shacoEditor.BuildHelperWindow.IOSCodeIndentity.Development:
                    {
                ...
                case shacoEditor.BuildHelperWindow.IOSCodeIndentity.Distribution:
                    {
        ...
        static private void BuildMods(string pathToBuiltProject)
        {
            ...
            string[] files = shaco.Base.FileHelper.GetFiles(Application.dataPath, "*.xcodemods", SearchOption.AllDirectories);
