    ...
    public class SequeueEvent : shaco.Base.BaseTree
    {
        ...
        public SequeueEventComponent Run()
        {
            ...
            if (null == firstEvent._actionTarget)
            {
                ...
                firstEvent._actionTarget.stackLocation.GetStack();
                shaco.UnityHelper.ChangeParent(firstEvent._actionTarget.gameObject, shaco.GameHelper.action.GetGlobalInvokeTarget().gameObject);
            }
