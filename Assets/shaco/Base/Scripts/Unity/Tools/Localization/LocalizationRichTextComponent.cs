...
// namespace shaco
// {
//     [RequireComponent(typeof(RichTextComponent))]
...
//         [HideInInspector]
//         public RichTextComponent richText = null;
...
//             if (null == richText)
//             {
//                 var componentFind = GetComponent<RichTextComponent>();
//                 if (componentFind == null)
//                 {
//                     richText = gameObject.AddComponent<RichTextComponent>();
//                 }
//                 else
...
//         {
//             CheckRichTextComponent();
//             richText.text = shaco.GameHelper.localization.GetTextFormat(_languageKey, formatParams);
// 			if (this._fontSize != 0)
// 			{
