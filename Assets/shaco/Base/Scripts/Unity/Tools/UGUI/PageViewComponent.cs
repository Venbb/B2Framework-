...
namespace shaco
{
    ...
    public class PageViewComponent : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                shaco.Log.Error("PageView forget set GridLayoutGroup model", this);
            }
        ...
        public void LocationWithPageIndex(int pageIndex)
        {
            ...
            var swapScript = _panelPage.GetComponent<SwapMoveActionComponent>();
            if (null == swapScript)
                return;
        ...
        public void OnGestureDragDirectionCallBack()
        {
            ...
            {
                shaco.Log.Error("PageView OnGestureDragDirectionCallBack error: missing input controller", this);
                return;
            }
        ...
        public void TurnFrontPage()
        {
            ...
            bool isNegative = scrollDirection == shaco.Direction.Left || scrollDirection == shaco.Direction.Up;
            _panelPage.GetComponent<SwapMoveActionComponent>().DoAction(!isNegative);
        }
        ...
        public void InsertItem(GameObject item, int insertIndex)
        {
            if (null == item)
            {
                shaco.Log.Error("PageView InsertItem error: item is null", this);
                return;
            }
            ...
            {
                shaco.Log.Error("PageView InsertItem error: out of range, insert index=" + insertIndex + " pageIndex=" + pageIndex + " count=" + _items.Count, this);
                return;
            }
        ...
        public void RemoveItem(int removeIndex)
        {
            ...
            {
                shaco.Log.Error("PageView RemoveItem error: out of range, remove index=" + removeIndex + " pageIndex=" + pageIndex + " count=" + _items.Count, this);
                return;
            }
        ...
        public void RemoveItem(GameObject item)
        {
            ...
            if (findItemIndex == -1)
            {
                shaco.Log.Error("PageView RemoveItem error: not found item=" + item, this);
                return;
            }
        ...
        public GameObject GetItem(int index)
        {
            ...
            if (pageIndex < 0 || pageIndex > _items.Count)
            {
                shaco.Log.Error("PageView InsertItem error: out of range, insert index=" + index + " pageIndex=" + pageIndex + " count=" + _items.Count, this);
                return retValue;
            }
        ...
        private void OnWillSwapMoveCallBack(GameObject target, GameObject next, bool isLeftToRight)
        {
            if (null == _panelPage || null == _placeholderObject)
                return;

            if (next == _placeholderObject)
            {
                var swapScript = _panelPage.GetComponent<SwapMoveActionComponent>();
                swapScript.lockActionWhenMoving = false;
        ...
        private int GetMaxItemsCountInPage(GameObject page)
        {
            ...
            {
                shaco.Log.Error("PageView GetMaxItemsCountInPage error: valid size, width=" + maxWidthCount + " height=" + maxHeightCount, this);
            }
        ...
        private void UpdatePageLayout(GameObject panelPage, int index, float widthPerPage, float heightPerPage)
        {
            ...
            {
                shaco.Log.Error("PageView UpdatePageLayout error: out of range index=" + index + " count=" + _panelPages.Count, this);
                return;
            }
            ...
            switch (scrollDirection)
            {
                ...
                default: shaco.Log.Error("PageView UpdatePagesLayout error: unsupport type=" + scrollDirection, this); break;
            }
        ...
        private void CheckComponent()
        {
            ...
            if (null != _gridGroupModel)
                ...
                shaco.Log.Error("PageView missing set Grid Group Model...", this);

            //auto set move action script
            var swapScript = _panelPage.GetComponent<SwapMoveActionComponent>();
            if (null == swapScript)
            {
                swapScript = _panelPage.AddComponent<SwapMoveActionComponent>();
                swapScript.onWillMoveCallBack = OnWillSwapMoveCallBack;
