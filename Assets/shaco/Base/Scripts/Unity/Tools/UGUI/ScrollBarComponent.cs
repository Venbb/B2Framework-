...
namespace shaco
{
    ...
    public class ScrollBarComponent : Scrollbar
    {
        public Image Background;

        private shaco.ScrollRectComponent _scrollRect = null;
        ...
        public override void OnDrag(UnityEngine.EventSystems.PointerEventData eventData)
        {
            ...
            if (null == _scrollRect)
            {
                _scrollRect = this.gameObject.GetComponentInParent<shaco.ScrollRectComponent>();
            }
            if (null != _scrollRect)
            {
                _scrollRect.UpdateDragEvent(eventData);
            }
        }

		public void AutoSetDirection(shaco.ListViewComponent listView)
		{
