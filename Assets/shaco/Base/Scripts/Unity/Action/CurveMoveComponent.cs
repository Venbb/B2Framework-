...
namespace shaco
{
    ...
    public class CurveMoveComponent : MonoBehaviour
    {
        ...
        private ActionBase _editorUpdateAction = null;
        private ActionBase _currentMoveAction = null;
        //数字越大编辑器模式下绘制的线条越顺滑
        ...
        public void CheckComponents()
        {
            ...
            else
            {
                ...
                {
                    _editorUpdateAction = Repeat.CreateRepeatForever(DelayTime.Create(999999));
        ...
        public void PlayMoveAction(Transform moveTarget, Vector3 moveEndWorldPosition, float duration)
        {
            ...
            if (duration > 0)
            {
                ...
                var actions = new ActionBase[movePaths.Count];
            ...
            else
            {
                ...
                for (int i = 0; i < movePaths.Count; ++i)
                {
                    actions[i] = CreatesMoveAction(movePaths[movePaths.Count - i - 1], duration / movePaths.Count).Reverse(this.moveTarget.gameObject);
                }
            ...
            {
                _currentMoveAction.onCompleteFunc += (shaco.ActionBase ac) =>
                {
        ...
        public void RemoveComponentWithMoveInfo(MoveInfo moveInfo)
        {
            ...
            {
                shaco.Log.Error("RemoveComponentWithMoveInfo exception: e=" + e, this);
            }
        }
        ...
        private ActionBase CreatesMoveAction(MoveInfo moveInfo, float duration)
        {
            ...
            switch (this.movePositionMode)
            {
                ...
                default: Log.Error("CurveMoveComponent CreatesMoveAction error: unsupport move mode=" + movePositionMode, this); break;
            }
        ...
        private int GetControlPointCountWithControlPointMode(MoveInfo moveInfo)
        {
            ...
            switch (moveInfo.controlPointMode)
            {
                ...
                default: shaco.Log.Error("GetControlPointCountWithControlPointMode erorr: unsupport type=" + moveInfo.controlPointMode, this); break;
            }
            return retValue;
        }
