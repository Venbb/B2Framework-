...
namespace shaco.ExcelDataReader
{
    ...
    public class ExcelDataTableConfiguration
    {
        ...
        /// </summary>
        public string EmptyColumnNamePrefix { get {return _EmptyColumnNamePrefix; } set{_EmptyColumnNamePrefix = value;} } 
        private string _EmptyColumnNamePrefix = "Column";

        /// <summary>
        /// Gets or sets a value indicating whether to use a row from the data as column names.
        /// </summary>
        public bool UseHeaderRow { get{return _UseHeaderRow;} set{_UseHeaderRow = value;} }
