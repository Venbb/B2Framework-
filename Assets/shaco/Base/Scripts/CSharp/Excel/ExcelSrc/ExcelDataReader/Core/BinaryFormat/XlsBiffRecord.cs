...
namespace shaco.ExcelDataReader.Core.BinaryFormat
{
    ...
    internal class XlsBiffRecord
    {
        ...
        /// </summary>
        public BIFFRECORDTYPE Id {get{return(BIFFRECORDTYPE)BitConverter.ToUInt16(Bytes, RecordContentOffset - ContentOffset); }}

        /// <summary>
        /// Gets the data size of this entry
        /// </summary>
        public ushort RecordSize {get{return BitConverter.ToUInt16(Bytes, RecordContentOffset - 2); }}

        /// <summary>
        /// Gets the whole size of structure
        /// </summary>
        public int Size {get{return ContentOffset + RecordSize; }}

        public virtual bool IsCell {get{return false; }}

        internal byte[] Bytes { get; }

        internal int RecordContentOffset { get; }

        internal int Offset {get{return RecordContentOffset - ContentOffset; }}
