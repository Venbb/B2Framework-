...
namespace shaco.ExcelDataReader.Core.NumberFormat
{
    internal class FractionSection
    {
        ...
        public static bool TryParse(List<string> tokens, out FractionSection format)
        {
            ...
            System.Collections.Generic.List<string> integerPart, numeratorPart;
            GetNumerator(numeratorParts, out integerPart, out numeratorPart);

            System.Collections.Generic.List<string> denominatorPrefix, denominatorPart, denominatorSuffix, fractionSuffix;
