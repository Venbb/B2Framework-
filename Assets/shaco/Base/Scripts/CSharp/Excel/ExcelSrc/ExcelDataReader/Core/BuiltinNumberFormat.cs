...
namespace shaco.ExcelDataReader.Core
{
    ...
    {
        private static Dictionary<int, NumberFormatString> Formats { get {return _Formats;} }
        private static Dictionary<int, NumberFormatString> _Formats = new Dictionary<int, NumberFormatString>()
        {
