...
namespace shaco.Base
{
    public static partial class FileHelper
    {
        ...
        /// </summary>
        static public void WriteAllByteByUserPathAsync(string path, byte[] data, System.Action<bool> callbackEnd = null, System.Action<float> callbackProgress = null)
        {
        ...
        /// </summary>
        static public void WriteAllByteByUserPathAsync(string path, byte[] data, bool overrite, System.Action<bool> callbackEnd = null, System.Action<float> callbackProgress = null)
        {
            ...
            {
                if (null != callbackProgress) callbackProgress(1.0f);
        ...
        /// <param name="callbackProgress">写入进度回调，允许为空</param>
        /// </summary>
        static public void AppendByUserPathAsync(string path, string data, System.Action<bool> callbackEnd = null, System.Action<float> callbackProgress = null)
        {
        ...
        /// <param name="callbackProgress">写入进度回调，允许为空</param>
        /// </summary>
        static public void WriteAllByUserPathAsync(string path, string data, System.Action<bool> callbackEnd = null, System.Action<float> callbackProgress = null)
        {
        ...
        /// </summary>
        static public void CopyFileByUserPathAsync(string pathOld, string pathNew, System.Action<bool> callbackEnd = null, params string[] ignorePatterns)
        {
        ...
        /// <param name="callbackEnd">拷贝完毕回调，允许为空</param>
        /// </summary>
        static public void MoveFileByUserPathAsync(string pathSource, string pathDest, System.Action<bool> callbackEnd = null)
        {
            bool isSuccess = false;
            ThreadPool.RunThreadSafeCallBack(() =>
            {
        ...
        /// </summary>
        static public void ReadAllByUserPathAsync(string path, System.Action<string> callbackEnd, System.Action<float> callbackProgress = null, string defaultValue = shaco.Base.GlobalParams.EmptyString)
        {
        ...
        /// </summary>
        static public void DeleteEmptyFolderAsync(string path, System.Action<bool> callbackEnd = null, params string[] ignorePatterns)
        {
            bool isSuccess = false;
            ThreadPool.RunThreadSafeCallBack(() =>
            {
