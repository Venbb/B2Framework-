...
//         private shaco.LogicLinker[] _listLogicLinker;
//         private shaco.LogicLinker.LinkItem _selectItem = null;
//         private List<shaco.LogicLinker.LinkID> _selectLinkID = new List<shaco.LogicLinker.LinkID>();
//         private shaco.LogicLinker _target = null;
//         private shaco.PopupListBox _popupBoxMenu = null;
...
//         private shaco.LogicLinker.LinkItem _itemCopy = null;
...
//         {
//             var retValue = EditorHelper.GetWindow<LogicLinkerEditor>(null, true, "shaco.LogicLinker") as LogicLinkerEditor;
...
//         void OnEnable()
//         {
//             _currentWindow = EditorHelper.GetWindow<LogicLinkerEditor>(this, true, "shaco.LogicLinker");
//         }

//         private void init()
//         {
//             _listLogicLinker = GameObject.FindObjectsOfType<shaco.LogicLinker>();
...
//         private void initWithScript(shaco.LogicLinker target)
//         {
//             if (target == null)
//             {
//                 GameObject objNew = new GameObject();
//                 objNew.name = objNew.GetType().Name;
//                 target = objNew.AddComponent<shaco.LogicLinker>();
//             }
//             _target = target;
...
//             {
//                 _popupBoxMenu = new shaco.PopupListBox();
//                 _popupBoxMenu.OnSelectCallBack = (string itemName, shaco.PopupListBox.EventType type) =>
//                 {
//                     if (itemName == "Link")
//                     {
//                         _isLinkMode = true;
...
//                         var prevSelectLinkID = new List<shaco.LogicLinker.LinkID>();
...
//             }
//             if (GUILayout.Button("Execute", guiButtonHeight))
//             {
//                 if (_selectItem != null)
//                 {
//                     bool success = true;
//                     if (_selectItem.LinkFrom.Count == 0)
//                         success = _target.tryExecuteWithUpdate(_selectItem, null);
//                     else
//                     {
//                         var fromItemTmp = _target.getLinkItemFrom(_selectItem, _selectLinkID);
//                         if (fromItemTmp != null)
//                             success = _target.tryExecuteWithUpdate(_selectItem, fromItemTmp);
//                         else
//                             shaco.Log.Info("please select a link line to " + _selectItem);
//                     }
//                     if (!success)
//                         shaco.Log.Info("Execute faild, doesn't meet the trigger condition");
//                 }
//             }
...
//             //draw link items 
//             _target.foreachLinkItems((shaco.LogicLinker.LinkItem item) =>
//             {
...
//                     _selectItem.RectSize.y), shaco.PopupListBox.EventType.TouchDown);
//             }
...
//         private void drawDefaultItem(shaco.LogicLinker.LinkItem target, bool isShow)
//         {
//             bool isWaitExecuteItem = _target.isWaitExecute(target.UUIDItem);
//             bool isPrevExecuteItem = _target.isPrevExecute(target.UUIDItem);
//             Color oldColor = GUI.color;

//             if (isWaitExecuteItem)
//                 GUI.color = _target.WaitExecuteItemColor;
//             else if (isPrevExecuteItem)
//                 GUI.color = _target.ExecutedItemColor;
...
//             //condition callback & execute callback
...
//             target.IsShowExecute = DrawEventDelegate("Execute", target.funcExecute, target.IsShowExecute, drawRect.width, _uiRowHeight);
...
//             if (isWaitExecuteItem || isPrevExecuteItem)
//                 GUI.color = oldColor;
//         }
...
//         private void drawEditFrameSize(shaco.LogicLinker.LinkItem target)
//         {
//             //edit frame size
...
//         private void drawEditItem(shaco.LogicLinker.LinkItem target)
//         {
//             //edit item
//             if (!_isDoubleClick)
//             {
...
//         private void drawLinkLine(shaco.LogicLinker.LinkItem target)
//         {
//             //draw link to lines
...
//         private void drawLinkItem(shaco.LogicLinker.LinkItem target)
//         {
...
//         private int getMinItemRowCount(shaco.LogicLinker.LinkItem item)
//         {
...
//                 ret += item.funcExecute.Count == 0 ? 1 : item.funcExecute.Count + 1;
//             return ret;
//         }

//         private void onDescriptionChanged(shaco.LogicLinker.LinkItem prevSelect)
//         {
