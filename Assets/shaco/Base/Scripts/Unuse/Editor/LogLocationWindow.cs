...
// {
//     /// <summary>
//     /// 该窗口已经没有再使用了，默认过滤日志为shaco框架路径
//     /// </summary>
//     [System.Obsolete]
//     public class LogLocationWindow : EditorWindow
//     {
...
//         private LogLocationWindow _currentWindow = null;
...
//         [MenuItem("shaco/Tools/LogLocationConfiguration", false, (int)(int)ToolsGlobalDefine.MenuPriority.Tools.LOG_LOCATION)]
//         static void OpenLogLocationWindow()
//         {
//             shacoEditor.EditorHelper.GetWindow<LogLocationWindow>(null, true, "LogLocationConfiguration");
//         }

//         void OnEnable()
//         {
//             _currentWindow = shacoEditor.EditorHelper.GetWindow<LogLocationWindow>(this, true, "LogLocationConfiguration");
//             _currentWindow.Init();
//         }
...
//             }
//             shaco.GameHelper.datasave.Write("LogLocationWindow_logEditorConfig", formatString);
//         }
...
//             bool hasError = false;
//             var formatString = shaco.GameHelper.datasave.ReadString("LogLocationWindow_logEditorConfig");
...
//                 SetLocationSetting(folderTmp.ContactPath("/CSharp/Tools/ObjectPool/ObjectPool.cs"));
...
//                 SetLocationSetting(folderTmp.ContactPath("/Unity/HotUpdate/ResourcesEditor.cs"));
//                 SetLocationSetting(folderTmp.ContactPath("/Unity/HotUpdate/ResourcesRuntime.cs"));
//                 SetLocationSetting(folderTmp.ContactPath("/Unity/HotUpdate/ResourcesOrLocalSequeue.cs"));
...
//                 SetLocationSetting(folderTmp.ContactPath("/Unity/Audio/AudioManagerBase.cs"));
//                 SetLocationSetting(folderTmp.ContactPath("/Unity/Audio/MusicManager.cs"));
//                 SetLocationSetting(folderTmp.ContactPath("/Unity/Audio/SoundManager.cs"));
...
//                 SetLocationSetting(folderTmp.ContactPath("/CSharp/Tools/ExtensionsUtility.cs"));
//                 SetLocationSetting(folderTmp.ContactPath("/CSharp/Tools/ExtensionsList.cs"));
//                 SetLocationSetting(folderTmp.ContactPath("/CSharp/Tools/ObjectPool/ExtensionsObjectPool.cs"));
...
//                 SetLocationSetting(folderTmp.ContactPath("/Unity/Tools/UnityObjectPool/ExtensionsUnityObjectPool.cs"));
...
//             {
//                 Debug.LogError("LogLocationWindow CanAddScriptPath error: not a csharp script, path=" + pathScript);
//                 return false;
//             }

//             if (_logEditorConfig.ContainsKey(pathScript))
//             {
//                 Debug.LogError("LogLocationWindow CanAddScriptPath error: duplicate script, path=" + pathScript);
//                 return false;
//             }
...
//             if (null == loadAsset)
//             {
//                 Debug.LogError("LogLocationWindow CanAddScriptPath error: missing script, path=" + pathScript);
//                 return false;
//             }
//             return true;
//         }
...
//             {
//                 Debug.LogError("LogLocationWindow SetLocationSetting error: not found class name, path=" + pathScript);
//                 return false;
//             }
