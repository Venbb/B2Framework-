Shader "shaco/UI/UIOutline" 
{
    Properties
    {
        ...
        _OutlineOffsetX ("Outline OffsetX", Float) = 0
        _OutlineOffsetY ("Outline OffsetY", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed SampleAlpha(int pIndex, v2f IN)
            {
                ...
                float2 offsetTmp = float2(-_OutlineOffsetX, _OutlineOffsetY);
                float2 pos = offsetTmp + IN.texcoord + _MainTex_TexelSize.xy * float2(cosArray[pIndex], sinArray[pIndex]) * _OutlineWidth;
