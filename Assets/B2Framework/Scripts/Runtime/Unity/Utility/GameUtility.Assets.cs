    ...
    public static partial class GameUtility
    {
        public static partial class Assets
        {
            ...
            public static string relativeDataPath
            {
                get
                {
                    return Utility.Path.Combine(AppConst.ASSETBUNDLES, runtimeMode ? platform + "/" : "");
                }
            }
            /// <summary>
            /// 本地持久化资源路径（可读写）
            ...
            public static string manifestFilePath
            {
                get
                {
                    var path = Utility.Text.Format("{0}.asset", AppConst.BUNDLE_MANIFEST);
            ...
            public static string GetAssetPath(string path)
            {
                ...
                if (path.StartsWith(AppConst.ASSETBUNDLE_ASSETS_PATH)) return path;
                return Utility.Path.Combine(AppConst.ASSETBUNDLE_ASSETS_PATH, path);
