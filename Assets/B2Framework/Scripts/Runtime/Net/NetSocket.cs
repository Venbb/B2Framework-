    ...
    public class NetSocket
    {
        ...
        private void DoConnect()
        {
            try
            {
                ...
                Debug.Log("try to connect host :" + _point.host);
                if (address.Length == 0)
                {
            ...
            catch (Exception e)
            {
                ...
                Debug.Log("DoConnect Err : " + e.ToString());
            }
        }
        public bool Send(int cmd, byte[] data)
        {
            ...
            {
                Debug.Log("SendCmd error :" + cmd + "," + e.ToString());
                Debug.Log("conid:" + conId + "conecntId:" + connectId);
        ...
        protected void DoRecv()
        {
            ...
            { //&& _socketStream.DataAvailable
                ...
                catch (Exception e)
                {
                    ...
                    AddEvent(new NetEvent(false, -1, null, "connect err!"));
                    Debug.Log("Read data from socket err :" + e.ToString());
                }
            }
