    ...
    public class LuaRuntime : MonoBehaviour
    {
        ...
        public void Send(string key, string value)
        {
            if (onNotify != null)
            {
                ...
                {
                    Debug.LogError("onNotify err : " + ex.Message + "\n" + ex.StackTrace);
                }
            }
        }
        ...
        void Update()
        {
            if (onUpdate != null)
            {
                ...
                {
                    Debug.LogError("onUpdate err : " + ex.Message + "\n" + ex.StackTrace);
                }
            }
        }
        void LateUpdate()
        {
            if (onLateUpdate != null)
            {
                ...
                {
                    Debug.LogError("onLateUpdate err : " + ex.Message + "\n" + ex.StackTrace);
                }
            }
        }
        void FixedUpdate()
        {
            if (onFixedUpdate != null)
            {
                ...
                {
                    Debug.LogError("onFixedUpdate err : " + ex.Message + "\n" + ex.StackTrace);
                }
            }
        }
